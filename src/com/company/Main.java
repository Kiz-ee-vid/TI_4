...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try (FileInputStream inputFile = new FileInputStream("test.txt");
             FileOutputStream outputFile = new FileOutputStream("shifr.txt")) {
            ...
            System.out.println("Зашифрованные данные находятся в shifr.txt");
        ...
        try (FileInputStream inputFile = new FileInputStream("shifr.txt");
             FileOutputStream outputFile = new FileOutputStream("deshifr.txt")) {
            ...
            outputFile.write(buffer, 0, buffer.length);
            System.out.println("Расшифрованные данные находятся в deshifr.txt");
